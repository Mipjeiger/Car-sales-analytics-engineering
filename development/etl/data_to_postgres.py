...
# Configuration
PARQUET_PATH = Path(__file__).resolve().parent.parent.parent / "development" / "database" / "car_sales.parquet"
...
def feature_engineering(df: pd.DataFrame) -> pd.DataFrame:
    ...
    try:
        ...
        # 4. Float columns
        float_columns = [
            'price', 'income_customer', 'discount', 'gross_sales',
            'discount_amount', 'sales', 'cost', 'total_cost',
