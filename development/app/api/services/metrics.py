...
MODEL_VERSIONS = Gauge(
    ...
    'Number of model versions in MLflow',
    ['model_name']
)
...
BUSINESS_DROPPED_IMPACT = Gauge(
    'business_dropped_impact',
    'Total dropped revenue impact in IDR'
)

BUSINESS_QUANTITY_SOLD = Gauge(
    'business_quantity_sold',
    'Total quantity of cars sold = quantity / car_id'
)
